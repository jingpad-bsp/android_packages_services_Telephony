    ...
    protected void hangup(int telephonyDisconnectCode) {
        if (mOriginalConnection != null) {
            try {
                ...
                if (e.getError() == android.telephony.DisconnectCause.IMS_ACCESS_BLOCKED) {
                    // UNISOC:modify for bug1059611
                    mHandler.sendMessageDelayed(mHandler.obtainMessage(MSG_HANGUP,
                            android.telephony.DisconnectCause.IMS_ACCESS_BLOCKED), 300);
                }
