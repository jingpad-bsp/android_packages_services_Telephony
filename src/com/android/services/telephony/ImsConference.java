...
public class ImsConference extends Conference implements Holdable {
            ...
            if ((mIsEmulatingSinglePartyCall && !isSinglePartyConference) ||
                ...
                for (ConferenceParticipant participant : participants) {
                    ...
                    if (!mConferenceParticipantConnections.containsKey(userEntity)) {
                        ...
                        // UNISOC:fix for bug 1243046
                        connection.setConnectionProperties(applyParticipantProperties(
                                parent.getConnectionProperties()));
                    }
                }
    ...
    /**
       * Update participant properties from the conference host.
       *
       * @param conferenceProperties The current conference properties.
       * @return The merged properties to be applied to the participant.
       */
    private int applyParticipantProperties(int properties) {
        int participantProperties = 0;
        participantProperties = changeBitmask(participantProperties,
                Connection.PROPERTY_HIGH_DEF_AUDIO,
                can(properties, Connection.PROPERTY_HIGH_DEF_AUDIO));
        participantProperties = changeBitmask(participantProperties, Connection.PROPERTY_WIFI,
                can(properties, Connection.PROPERTY_WIFI));
