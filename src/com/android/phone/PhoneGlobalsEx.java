...
import com.android.internal.telephony.uicc.SimLockController;
import com.android.phone.SuppServiceConsumer;
import com.android.phone.settings.fdn.FdnHelper;
import com.android.phone.simlock.NckSimLockUtil;
...
public class PhoneGlobalsEx extends ContextWrapper {
    ...
    public void onCreate() {
        ...
        SimLockController.init(mContext);

        /* UNISOC: Operator nck simlock @{ */
        if (NckSimLockUtil.isNckSimLockEnabled(mContext)
                && NckSimLockUtil.getRemainTimes(mContext) == -1) {
            NckSimLockUtil.saveRemainTimes(mContext, NckSimLockUtil.NCK_SIMLOCK_REMAIN_TIMES_MAX);
        }
        /* @} */
    }
