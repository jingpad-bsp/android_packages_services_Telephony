...
public class CallFeaturesSetting extends PreferenceActivity
    ...
    private Dialog mOpenDataDialog = null;
    ...
    private boolean doSsOverUtPrecautions(Preference preference) {
        ...
        if (b != null && b.getBoolean(configKey)
            ...
            // UNISOC: Add for bug#1319497
            if (mOpenDataDialog != null && mOpenDataDialog.isShowing()) {
                log("showOpenDataDialog(), Open Data Dialog is showing!");
                return true;
            }
            mOpenDataDialog = SuppServicesUiUtil.showBlockingSuppServicesDialog(this, mPhone,
