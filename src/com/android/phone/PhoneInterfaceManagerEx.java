...
public class PhoneInterfaceManagerEx extends ITelephonyEx.Stub {
    ...
    */
    public boolean isDefaultDataCardSwitchAllowed() {
        SimLockController simLockController = SimLockController.getInstance();
        if (simLockController == null) {
            return true;
        }
        return simLockController.isDefaultDataCardSwitchAllowed();
    }
    ...
    */
    public boolean isWhiteListCard(int phoneId) {
        ...
        return simLockController.isWhiteListCard(phoneId);
    }
}
